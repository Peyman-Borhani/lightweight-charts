...
This demo app example uses [svelte-lightweight-charts](https://github.com/trash-and-fire/svelte-lightweight-charts) which is a Svelte wrapper for [lightweight-charts](https://github.com/tradingview/lightweight-charts)
...
download the project and if needed
```bash
pnpm create vite app-name -- --template svelte
```

In the app folder:

```bash
pnpm install lightweight-charts svelte-lightweight-charts
```
if you didn't download project, copy the App.svelte and data.js files or copy these file contents 
```bash
pnpm i
pnpm run dev
```
